...
def _create_token(client, email_address):
...
def test_reset_password_token_creation(client, users):
    user = users[0]
...
def test_send_reset_password_email(client, app, mocker, users):
