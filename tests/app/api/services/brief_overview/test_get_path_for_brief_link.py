...
def test_correct_path_returned(brief, framework, lot, work_order):
    ...
    path = brief_overview_service.get_path_for_brief_link(test_brief, '{path}/random/string/{work_order_id}/foo/bar')
    assert path == ((
...
def test_correct_path_returned_for_title(outcome_brief):
    path = brief_overview_service.get_path_for_brief_link(outcome_brief, '{path}/edit/title/title')
...
def test_correct_path_returned_for_role(specialist_brief):
    path = brief_overview_service.get_path_for_brief_link(specialist_brief, '{path}/edit/role/title')
...
def test_correct_path_returned_for_location(brief, framework, lot):
    test_brief = brief(framework, lot())
    path = brief_overview_service.get_path_for_brief_link(test_brief, '{path}/edit/location/location')
...
def test_correct_path_returned_for_description_of_work(brief, framework, lot):
    test_brief = brief(framework, lot())
    path = brief_overview_service.get_path_for_brief_link(test_brief, '{path}/description-of-work')
...
def test_correct_path_returned_for_question_and_answer_session(brief, framework, lot):
    test_brief = brief(framework, lot())
    path = brief_overview_service.get_path_for_brief_link(test_brief, '{path}/question-and-answer-session-details')
...
def test_correct_path_returned_for_who_can_respond(brief, framework, lot):
    test_brief = brief(framework, lot())
    path = brief_overview_service.get_path_for_brief_link(test_brief, '{path}/edit/who-can-respond/specifySeller')
...
def test_correct_path_returned_for_review_and_publish(brief, framework, lot):
    test_brief = brief(framework, lot())
    path = brief_overview_service.get_path_for_brief_link(test_brief, '{path}/publish')
...
def test_correct_path_returned_for_answer_a_question(brief, framework, lot):
    test_brief = brief(framework, lot())
    path = brief_overview_service.get_path_for_brief_link(test_brief, '{path}/supplier-questions/answer-question')
...
def test_correct_path_returned_for_view_responses(brief, framework, lot):
    test_brief = brief(framework, lot())
    path = brief_overview_service.get_path_for_brief_link(test_brief, '/2/brief/{brief_id}/download-responses')
...
def test_correct_path_returned_for_evaluation_template(brief, framework, lot):
    test_brief = brief(framework, lot())
    path = brief_overview_service.get_path_for_brief_link(test_brief, '/static/media/documents/Scoring_Template.xlsx')
...
def test_correct_path_returned_for_start_work_order(brief, framework, lot):
    test_brief = brief(framework, lot())
    path = brief_overview_service.get_path_for_brief_link(test_brief, '{path}/work-orders/create')
...
def test_correct_path_returned_for_edit_work_order(brief, framework, lot, work_order):
    test_brief = brief(framework, lot())
    test_brief.work_order = work_order
    path = brief_overview_service.get_path_for_brief_link(test_brief, '/work-orders/{work_order_id}')
