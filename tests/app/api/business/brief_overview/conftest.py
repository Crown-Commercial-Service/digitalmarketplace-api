...
@pytest.fixture()
def framework():
    yield Framework(id=1, slug='digital-marketplace')


@pytest.fixture()
def work_order():
    yield WorkOrder(id=1)


@pytest.fixture()
def outcome_lot():
    yield Lot(id=1, slug='digital-outcome', one_service_limit=True)


@pytest.fixture()
def specialist_lot():
    yield Lot(id=1, slug='digital-professionals', one_service_limit=True)


@pytest.fixture()
def outcome_brief(framework, outcome_lot):
    yield Brief(id=1, data={}, framework=framework, lot=outcome_lot, work_order=None)


@pytest.fixture()
def specialist_brief(framework, specialist_lot):
    yield Brief(id=1, data={}, framework=framework, lot=specialist_lot, work_order=None)
