...
from tests.helpers import FixtureMixin, DIRECT_AWARD_SEARCH_URL, DIRECT_AWARD_PROJECT_NAME
...
class TestDirectAwardProjects(BaseApplicationTest, FixtureMixin):
...
class TestDirectAwardProjectUsers(BaseApplicationTest, FixtureMixin):
...
class TestDirectAwardSearches(BaseApplicationTest, FixtureMixin):
...
class TestDirectAwardProjectSearchResultEntries(BaseApplicationTest, FixtureMixin):
