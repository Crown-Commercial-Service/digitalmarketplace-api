...
@main.route('/dashboard/buyers', methods=['GET'])
...
@main.route('/dashboard/suppliers', methods=['GET'])
...
@main.route('/dashboard/roles', methods=['GET'])
def get_roles_stats():
    top_roles = []
...
@main.route('/dashboard/briefs', methods=['GET'])
