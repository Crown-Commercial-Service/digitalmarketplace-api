You’re invited to submit up to {{number_of_suppliers}} candidate{{number_of_suppliers_plural}} for [{{brief_name}} ({{brief_id}})]({{frontend_url}}/2/digital-marketplace/opportunities/{{brief_id}}) at {{brief_organisation}}.  
